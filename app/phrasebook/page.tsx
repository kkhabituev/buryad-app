  ...
  return (
    <div className="page-enter" style={{ background: "#f8faff", minHeight: "100dvh" }}>
      ...
      >
        ...
        <p className="text-xs font-bold uppercase tracking-widest mb-1" style={{ color: "rgba(255,255,255,0.6)" }}>Хэлэлсэгшэ</p>
      ...
      <div className="px-4 pt-8 pb-6 flex flex-col items-center text-center">
        ...
        <p className="text-sm mb-6" style={{ color: "#64748b" }}>Разговорные фразы по ситуациям</p>

        <div className="w-full space-y-3">
          {phrasebookData.situations.map((s) => (
            <div key={s.id} className="flex items-center gap-4 rounded-2xl px-5 py-4" style={{ background: "white", border: "2px solid #e2e8f0" }}>
              <span className="text-2xl">{s.emoji}</span>
              <div className="text-left">
                <div className="text-sm font-bold" style={{ color: "#1e3a5f" }}>{s.name}</div>
