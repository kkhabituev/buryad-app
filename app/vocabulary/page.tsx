...
export default function VocabularyPage() {
  ...
  // ── Search suggestions + auto-translate on type ────────
  useEffect(() => {
    ...
    debounceRef.current = setTimeout(async () => {
      ...
      // Auto-translate immediately — no extra tap needed
        ...
        <div className="px-4 pt-4 pb-24">
          ...
          <div className="relative">
            ...
            {suggestions.length > 0 && (
              <div className="absolute left-0 right-0 rounded-2xl overflow-hidden z-20 mt-1" style={{ background: "white", border: "2px solid #e2e8f0", boxShadow: "0 8px 24px rgba(0,0,0,0.1)" }}>
                {suggestions.map((s, i) => (
                  <button
                    key={s}
                    type="button"
          ...
          {/* Empty state: history or examples */}
          {!query && !translation && (
            <div className="mt-4">
              {history.length > 0 ? (
                <>
